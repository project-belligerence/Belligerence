(function() {
	...
	var moduleName = "Objectives",
		moduleNameSingle = "Objective",
	...
	function routeList() {
		var routeParams = [
			"qName",
			"qHourLimitMin", "qHourLimitMax",
			"qDifficultyMin", "qDifficultyMax",
			"qBaseRewardMin", "qBaseRewardMax",
			"qDoctrineTypes", "qLocationTypes",
			"qDisabledMaps",
			"qCapture", "qAdversarial"
		].join("&?");
	...
	function routeSingle() {
		var getObjectFunc = "getObjective";
		...
		return {
			...
			resolve: {
				...
				locationData: ['generalServices', function (generalServices) {return generalServices.getLocationTypes();}]
			}
		};
	}
